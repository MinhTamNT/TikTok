export const upLoadIcons = ({ width = '3.2rem', classNameUpLoad, height = '3.2rem' }) => (
    <svg
...
export const MessgaeIcons = ({ width = '2.6rem', classNameMess, height = '2.6rem' }) => (
    <svg
        class={classNameMess}
        width={width}
        height={height}
...
export const BoxMessage = ({ width = '2.6rem', classNamebox, height = '2.6rem' }) => (
    <svg
        class={classNamebox}
        width={width}
        height={height}
